...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Patient Registration.create': {
    roles: ['system-administrator', 'healthcare-provider', 'po', 'aim', 'test', 'test-1', 'test-2', 'test-3'],
    key: 'A new patient has been registered in the system. Please review the details.',
    tenantPath: [],
    userPath: [],
  },
  'New Order Placement.create': {
    roles: ['system-administrator', 'healthcare-provider', 'po', 'aim', 'test', 'test-1', 'test-2', 'test-3'],
    key: 'A new order has been placed in the system. Please review the details.',
    tenantPath: [],
    userPath: [],
  },
  'New Appointment Scheduling.create': {
    roles: ['system-administrator', 'healthcare-provider', 'po', 'aim', 'test', 'test-1', 'test-2', 'test-3'],
    key: 'A new appointment has been scheduled in the system. Please review the details.',
    tenantPath: [],
    userPath: [],
  },
};
...
const customerRoles: string[] = ['fgfg'];
...
export async function notificationHandlerMiddleware(req: NextApiRequest, entityId: string) {
  ...
  const tenant = await prisma.dfdfwe.findFirst({
