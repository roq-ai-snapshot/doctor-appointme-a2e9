...
import { getDfdfweById } from 'apiSdk/dfdfwes';
import { DfdfweInterface } from 'interfaces/dfdfwe';

function DfdfweViewPage() {
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('dfdfwe', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/dfdfwes/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="dfdfwe" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
